...
OpenAPI、Go の構成、DB モデル、queue、artifact 配信、GitHub 連携、デプロイは [docs/backend/summary.md](/Users/f0reach/workspace/boardflow/docs/backend/summary.md) を基点に詰める。
